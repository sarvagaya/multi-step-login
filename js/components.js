    ...
    return `
          <div class="space-y-6">
                          <div class="space-y-2">
                              ...
                              <input type="password" id="password" value="${allData.password || ""
      }" class="w-full p-4 bg-slate-50 border rounded-2xl">
                                  <span class="text-xs font-black ${passwordConfig.textColor
      }">${passwordConfig.label}</span>
                          </div>
                          <div class="space-y-2">
                              <label class="text-sm font-bold text-black">Confirm Password</label>
                              <input type="password" id="confirmPassword" value="${allData.confirmPassword || ""
      ...
      .map(([key, value]) => {
        ...
        return `
                <div>
                    ...
                    <p class="font-bold text-black text-lg">${displayValue || "—"
          }</p>
                </div>`;
      })
      .join("");
      ...
      <div class="space-y-6">
          <div class="space-y-2">
              ...
              <div class="flex flex-col gap-4">
                  <input type="text" id="commVerification" maxlength="4" value="${val || ""
      }" 
